...
真白板（无限画布）✅ + **AI 团队进板**（读图 / 摆元素 / 照白板干活）**⏳ 未落地**。人主画、AI 助手。**不做**对话总览画布的升级版（那张顶栏总览本身已撤 → [协作图 UX §六](/docs/04-前端/协作图与双视图UX.md)）、不做独立 app。空间 JSON 与「文本典范」不冲突——scene 本质空间，文本表达不了。重叠面（团队图/mermaid/文件列表）不重做。

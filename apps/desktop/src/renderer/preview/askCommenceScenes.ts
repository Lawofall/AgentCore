...
export const ASK_COMMENCE_SCENES: AskCommenceScene[] = [
  ...
  },
  {
    ...
    title: "Brief + Choose",
    intent:
      "【已退役】题干与选项常驻（紧凑单行选项）；brief 折叠；人话常驻。风格 pills 常驻一行。",
  ...
  },
  {
    ...
    intent:
      "【现生产】通用澄清卡 AskDecisionBody：无开工提案仪式；多题一次一面、编号可切、单选首次勾选自动切下一题、非末题「下一题」末题提交；打开不预选 default；不是 Wizard；wire 空 style/format 不渲染场面区。",

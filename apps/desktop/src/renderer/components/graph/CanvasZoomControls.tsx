 ...
 * (interactive) floats this vertical 放大 / 缩小 / 适应 pill bottom-left.
 * The chat embed is not interactive and does not show this cluster. Each
 * GraphView wires its own ReactFlow instance through the callbacks. (Fit moved
 * here from GraphToolbar, which now selects layout only — zoom + fit live together.)
 */
